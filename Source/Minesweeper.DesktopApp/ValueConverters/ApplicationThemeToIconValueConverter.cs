...
public class ApplicationThemeToIconValueConverter : ValueConverterBase<ApplicationThemeToIconValueConverter>
{
    ...
    public override object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        return theme switch
        {
            ApplicationTheme.Light => LightThemeIcon,
            ApplicationTheme.Dark => DarkThemeIcon,
            _ => throw new InvalidEnumArgumentException(nameof(value), (int)theme, typeof(ApplicationTheme))
        };
    }
