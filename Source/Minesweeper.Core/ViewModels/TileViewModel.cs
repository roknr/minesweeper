...
namespace Minesweeper.Core.ViewModels
{
    ...
    public class TileViewModel : ViewModelBase
    {
        ...
        public TileViewModel(int row, int column, int adjacentBombs, TileState state)
        {
            ...
            UncoverCommand = new RelayCommand(p => OnTileUncovering());
            ToggleMarkCommand = new RelayCommand(p => OnTileToggledMark());
        }
        ...
        private void OnTileToggledMark()
        {
            ...
            if (MarkedState == TileMarkedState.Unmarked)
                MarkedState = TileMarkedState.Flag;
            else if (MarkedState == TileMarkedState.Flag)
                MarkedState = TileMarkedState.QuestionMark;
            else
                MarkedState = TileMarkedState.Unmarked;
