...
public class ApplicationViewModel : ViewModelBase
{
    ...
    public ApplicationViewModel()
    {
        ...
        UserSettings.PropertyChanged += (o, e) =>
        {
            ...
            if (!string.Equals(e.PropertyName, nameof(UserSettingsViewModel.Theme), StringComparison.Ordinal))
            {
                return;
            }
    ...
    private static void OnThemeChanged(ApplicationTheme newTheme)
    {
